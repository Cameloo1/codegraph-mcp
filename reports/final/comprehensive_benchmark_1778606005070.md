...
| Metric | Target | Observed | Status | Notes |
| --- | --- | --- | --- | --- |
| `single_file_update_total_ms` | 750.000 | 373.000 | pass | Single-file update p95 target is <=750 ms. |
...
| `update_restore_time_ms` | reported | 273.000 | pass | Restore update duration from update-integrity harness. |
