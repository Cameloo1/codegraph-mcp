...
- Status: **passed**
- DB: `<REPO_ROOT>/Desktop\development\codegraph-mcp\reports\final\artifacts\comprehensive_proof_cgc_recovery_20260513.sqlite`
- Iterations: `20`

| Query | Status | p50 ms | p95 ms | p99 ms | rows | target p95 |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 1.946 | 2.947 | 2.947 | 20 | 250.000 |
| `symbol_lookup` | `pass` | 191.987 | 226.810 | 226.810 | 20 | 250.000 |
| `qname_lookup` | `pass` | 19.159 | 19.924 | 19.924 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.047 | 0.194 | 0.194 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 227.957 | 236.474 | 236.474 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 228.492 | 238.205 | 238.205 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 2.580 | 4.443 | 4.443 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 48.898 | 51.370 | 51.370 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 128.758 | 140.259 | 140.259 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 92.030 | 98.392 | 98.392 | 0 | 1000 |
