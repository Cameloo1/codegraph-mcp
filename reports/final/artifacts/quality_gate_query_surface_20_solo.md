...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 1.926 | 3.677 | 3.677 | 20 | 250.000 |
| `symbol_lookup` | `pass` | 193.926 | 216.197 | 216.197 | 20 | 250.000 |
| `qname_lookup` | `pass` | 20.582 | 25.463 | 25.463 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.059 | 0.239 | 0.239 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 268.925 | 291.549 | 291.549 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 248.333 | 271.907 | 271.907 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 2.825 | 4.456 | 4.456 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 53.920 | 69.796 | 69.796 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 141.339 | 158.565 | 158.565 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 97.271 | 115.450 | 115.450 | 0 | 1000 |
