...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 2.300 | 2.923 | 2.923 | 20 | 250.000 |
| `symbol_lookup` | `pass` | 209.346 | 240.703 | 240.703 | 20 | 250.000 |
| `qname_lookup` | `pass` | 20.158 | 28.465 | 28.465 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.114 | 0.297 | 0.297 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 243.388 | 277.416 | 277.416 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 250.836 | 271.406 | 271.406 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 3.821 | 5.489 | 5.489 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 52.299 | 63.716 | 63.716 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 138.760 | 162.344 | 162.344 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 95.033 | 123.782 | 123.782 | 0 | 1000 |
