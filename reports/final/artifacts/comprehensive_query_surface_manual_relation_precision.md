...
- Status: **passed**
- DB: `C:\Users\CodexSandboxOffline\.codex\.sandbox\cwd\eefaac708b6e3491\reports\final\artifacts\comprehensive_proof_1778642765060.sqlite`
- Iterations: `20`

| Query | Status | p50 ms | p95 ms | p99 ms | rows | target p95 |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 1.847 | 2.660 | 2.660 | 20 | 250.000 |
| `symbol_lookup` | `pass` | 199.356 | 226.865 | 226.865 | 20 | 250.000 |
| `qname_lookup` | `pass` | 19.716 | 22.395 | 22.395 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.051 | 0.203 | 0.203 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 244.920 | 254.086 | 254.086 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 243.082 | 269.835 | 269.835 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 2.638 | 3.855 | 3.855 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 51.412 | 63.638 | 63.638 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 132.957 | 149.321 | 149.321 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 94.267 | 106.661 | 106.661 | 0 | 1000 |
