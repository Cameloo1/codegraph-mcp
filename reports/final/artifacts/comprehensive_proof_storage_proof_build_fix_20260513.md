...
Database: `<REPO_ROOT>/Desktop/development/codegraph-mcp/reports/final/artifacts/comprehensive_proof_proof_build_fix_20260513.sqlite`

- DBSTAT available: `true`
- Database bytes: `179499008`
- WAL bytes: `0`
- SHM bytes: `0`
- File family bytes: `179499008`
- Page size: `4096`
- Page count: `43823`
- Freelist count: `0`
...
- Tables: `56`
- Indexes: `52`
- Observed table rows: `1732842`
- Proof edge rows: `31775`
- Structural relation rows: `0`
- Callsite rows: `2177`
- Callsite argument rows: `27980`
- Semantic edge/fact rows: `61932`
- Average database bytes per proof edge: `5649.06`
- Average database bytes per semantic edge/fact: `2898.32`
- Average edge table bytes per proof edge: `65.36`
- Average edge table plus edge-index bytes per proof edge: `118.59`
- Source-span rows: `0`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `template_entities` | `table` | 653819 | 58146816 | 49278323 | 6736670 | 32.39 |
| `template_edges` | `table` | 169290 | 17743872 | 14661965 | 2522057 | 9.89 |
...
| `file_edges` | `table` | 62886 | 6897664 | 5874315 | 813373 | 3.84 |
| `entities` | `table` | 89407 | 6787072 | 5952762 | 546023 | 3.78 |
| `file_source_spans` | `table` | 61932 | 6778880 | 5799813 | 772301 | 3.78 |
| `idx_file_edges_edge` | `index` | unknown | 6160384 | 5874315 | 78253 | 3.43 |
| `qname_prefix_dict` | `table` | 48603 | 6148096 | 5725505 | 105642 | 3.43 |
| `idx_file_source_spans_span` | `index` | unknown | 6078464 | 5799813 | 73937 | 3.39 |
| `idx_qualified_name_parts` | `index` | unknown | 4624384 | 3249646 | 533701 | 2.58 |
| `path_evidence` | `table` | 4096 | 4562944 | 4122462 | 398265 | 2.54 |
...
| `edges` | `table` | 31775 | 2076672 | 1729645 | 244492 | 1.16 |
| `files` | `table` | 4975 | 1695744 | 1452837 | 218043 | 0.94 |
| `callsite_args` | `table` | 27980 | 1540096 | 1288777 | 162871 | 0.86 |
| `path_evidence_edges` | `table` | 4096 | 1335296 | 1073095 | 241909 | 0.74 |
...
| `path_evidence_symbols` | `table` | 8192 | 729088 | 606208 | 96172 | 0.41 |
...
| `idx_edges_head_relation` | `index` | unknown | 593920 | 493690 | 3169 | 0.33 |
| `idx_edges_tail_relation` | `index` | unknown | 593920 | 493689 | 3170 | 0.33 |
| `path_evidence_lookup` | `table` | 4096 | 589824 | 551667 | 11420 | 0.33 |
| `idx_edges_span_path` | `index` | unknown | 503808 | 401516 | 5495 | 0.28 |
| `sqlite_autoindex_path_dict_1` | `index` | unknown | 442368 | 370188 | 55962 | 0.25 |
| `path_dict` | `table` | 4975 | 397312 | 360366 | 10660 | 0.22 |
| `idx_path_evidence_lookup_source` | `index` | unknown | 315392 | 289395 | 12789 | 0.18 |
| `idx_path_evidence_lookup_target` | `index` | unknown | 315392 | 289395 | 12789 | 0.18 |
| `file_path_evidence` | `table` | 4096 | 299008 | 244306 | 41542 | 0.17 |
| `path_evidence_files` | `table` | 4096 | 299008 | 244306 | 41542 | 0.17 |
| `idx_path_evidence_edges_edge` | `index` | unknown | 294912 | 270336 | 11428 | 0.16 |
| `idx_file_path_evidence_path` | `index` | unknown | 270336 | 244306 | 12954 | 0.15 |
| `idx_path_evidence_files_file` | `index` | unknown | 270336 | 244306 | 12954 | 0.15 |
...
| `source_content_template` | `table` | 2715 | 200704 | 173421 | 18554 | 0.11 |
| `sqlite_autoindex_source_content_template_1` | `index` | unknown | 196608 | 157309 | 30582 | 0.11 |
| `sqlite_autoindex_path_evidence_1` | `index` | unknown | 143360 | 114560 | 16096 | 0.08 |
| `sqlite_autoindex_path_evidence_lookup_1` | `index` | unknown | 143360 | 114560 | 16096 | 0.08 |
| `sqlite_autoindex_edge_provenance_dict_1` | `index` | unknown | 131072 | 102709 | 24590 | 0.07 |
| `callsites` | `table` | 2177 | 126976 | 99947 | 20130 | 0.07 |
| `idx_path_evidence_edges_path_ordinal` | `index` | unknown | 126976 | 106496 | 7824 | 0.07 |
| `edge_provenance_dict` | `table` | 1131 | 114688 | 100575 | 8151 | 0.06 |
| `idx_path_evidence_lookup_signature` | `index` | unknown | 106496 | 88691 | 5209 | 0.06 |
...
| `sqlite_schema` | `schema` | unknown | 32768 | 25816 | 6172 | 0.02 |
...
| `entity_id_history` | `table` | 21 | 4096 | 462 | 3563 | 0.00 |
...
| `file_edges` | 62886 | 6897664 | 5874315 | 109.69 | 93.41 |
| `entities` | 89407 | 6787072 | 5952762 | 75.91 | 66.58 |
| `file_source_spans` | 61932 | 6778880 | 5799813 | 109.46 | 93.65 |
| `qname_prefix_dict` | 48603 | 6148096 | 5725505 | 126.50 | 117.80 |
| `path_evidence` | 4096 | 4562944 | 4122462 | 1114.00 | 1006.46 |
| `qualified_name_dict` | 275831 | 4403200 | 2730879 | 15.96 | 9.90 |
| `edges` | 31775 | 2076672 | 1729645 | 65.36 | 54.43 |
| `files` | 4975 | 1695744 | 1452837 | 340.85 | 292.03 |
| `callsite_args` | 27980 | 1540096 | 1288777 | 55.04 | 46.06 |
| `path_evidence_edges` | 4096 | 1335296 | 1073095 | 326.00 | 261.99 |
| `path_evidence_symbols` | 8192 | 729088 | 606208 | 89.00 | 74.00 |
| `path_evidence_lookup` | 4096 | 589824 | 551667 | 144.00 | 134.68 |
| `path_dict` | 4975 | 397312 | 360366 | 79.86 | 72.44 |
| `file_path_evidence` | 4096 | 299008 | 244306 | 73.00 | 59.65 |
| `path_evidence_files` | 4096 | 299008 | 244306 | 73.00 | 59.65 |
| `source_content_template` | 2715 | 200704 | 173421 | 73.92 | 63.88 |
| `callsites` | 2177 | 126976 | 99947 | 58.33 | 45.91 |
| `edge_provenance_dict` | 1131 | 114688 | 100575 | 101.40 | 88.93 |
...
| `entity_id_history` | 21 | 4096 | 462 | 195.05 | 22.00 |
...
| Exactness | Edges |
| --- | ---: |
| `derived_from_verified_edges` | 1130 |
...
| `idx_file_edges_edge` | `file_edges` | `edge_id`, `file_id` | 6160384 | `false` | `c` | none | `no mapped default workflow observed; verify with query plans before keeping` |
| `idx_file_source_spans_span` | `file_source_spans` | `span_id`, `file_id` | 6078464 | `false` | `c` | none | `no mapped default workflow observed; verify with query plans before keeping` |
...
| `idx_file_path_evidence_path` | `file_path_evidence` | `path_id`, `file_id` | 270336 | `false` | `c` | none | `no mapped default workflow observed; verify with query plans before keeping` |
| `idx_path_evidence_files_file` | `path_evidence_files` | `file_id`, `path_id` | 270336 | `false` | `c` | none | `no mapped default workflow observed; verify with query plans before keeping` |
