...
Database: `reports/audit/artifacts/content_template_dedupe_autoresearch_v7.sqlite`

- DBSTAT available: `true`
- Database bytes: `336203776`
- WAL bytes: `0`
- SHM bytes: `0`
- File family bytes: `336203776`
- Page size: `4096`
- Page count: `82081`
- Freelist count: `0`
...
- Tables: `55`
- Indexes: `54`
- Observed table rows: `2812892`
- Proof edge rows: `31848`
- Structural relation rows: `0`
- Callsite rows: `2177`
- Callsite argument rows: `27980`
- Semantic edge/fact rows: `62005`
- Average database bytes per proof edge: `10556.51`
- Average database bytes per semantic edge/fact: `5422.20`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `template_entities` | `table` | 653819 | 87523328 | 75801704 | 9502454 | 26.03 |
| `template_edges` | `table` | 169290 | 40804352 | 34356421 | 5651231 | 12.14 |
| `symbol_dict` | `table` | 696373 | 30392320 | 25916469 | 188213 | 9.04 |
| `qname_prefix_dict` | `table` | 155741 | 22274048 | 20771044 | 412051 | 6.63 |
| `idx_template_edges_head_relation` | `index` | unknown | 16539648 | 15913260 | 70066 | 4.92 |
| `idx_template_edges_tail_relation` | `index` | unknown | 16539648 | 15913260 | 70066 | 4.92 |
| `idx_symbol_dict_hash` | `index` | unknown | 14602240 | 11109040 | 1361305 | 4.34 |
| `idx_qualified_name_parts` | `index` | unknown | 12742656 | 9161622 | 1361590 | 3.79 |
| `qualified_name_dict` | `table` | 727372 | 12173312 | 7739773 | 35402 | 3.62 |
| `file_entities` | `table` | 89407 | 10248192 | 8673290 | 1272838 | 3.05 |
| `idx_file_entities_entity` | `index` | unknown | 9097216 | 8673290 | 125234 | 2.71 |
| `path_evidence` | `table` | 4096 | 8519680 | 7115002 | 1347044 | 2.53 |
| `file_edges` | `table` | 62959 | 6914048 | 5883234 | 820531 | 2.06 |
| `entities` | `table` | 89407 | 6803456 | 5960003 | 555118 | 2.02 |
| `file_source_spans` | `table` | 62005 | 6795264 | 5808732 | 779459 | 2.02 |
| `idx_file_edges_edge` | `index` | unknown | 6168576 | 5883234 | 77243 | 1.83 |
| `idx_file_source_spans_span` | `index` | unknown | 6094848 | 5808732 | 81095 | 1.81 |
| `idx_qname_prefix_dict_hash` | `index` | unknown | 3309568 | 2515701 | 316952 | 0.98 |
| `edges` | `table` | 31848 | 2105344 | 1740018 | 262415 | 0.63 |
| `files` | `table` | 4975 | 1695744 | 1452837 | 218043 | 0.50 |
| `callsite_args` | `table` | 27980 | 1540096 | 1288777 | 162871 | 0.46 |
| `idx_entities_qname` | `index` | unknown | 1028096 | 752584 | 4283 | 0.31 |
| `idx_entities_name` | `index` | unknown | 1015808 | 740803 | 3812 | 0.30 |
| `path_evidence_edges` | `table` | 4096 | 946176 | 795314 | 131710 | 0.28 |
| `idx_entities_path` | `index` | unknown | 937984 | 663193 | 3826 | 0.28 |
| `path_evidence_symbols` | `table` | 8192 | 712704 | 606208 | 79836 | 0.21 |
| `idx_path_evidence_symbols_entity` | `index` | unknown | 638976 | 606208 | 6324 | 0.19 |
| `idx_path_evidence_symbols_path` | `index` | unknown | 638976 | 606208 | 6324 | 0.19 |
| `idx_edges_head_relation` | `index` | unknown | 593920 | 494858 | 1782 | 0.18 |
| `idx_edges_tail_relation` | `index` | unknown | 593920 | 494857 | 1783 | 0.18 |
| `path_evidence_lookup` | `table` | 4096 | 589824 | 551887 | 11200 | 0.18 |
| `idx_edges_span_path` | `index` | unknown | 503808 | 402465 | 4327 | 0.15 |
| `sqlite_autoindex_path_dict_1` | `index` | unknown | 442368 | 370188 | 55962 | 0.13 |
| `path_dict` | `table` | 4975 | 397312 | 360366 | 10660 | 0.12 |
| `idx_path_evidence_lookup_source` | `index` | unknown | 315392 | 289615 | 12569 | 0.09 |
| `idx_path_evidence_lookup_target` | `index` | unknown | 315392 | 289615 | 12569 | 0.09 |
| `file_path_evidence` | `table` | 4096 | 299008 | 247523 | 38285 | 0.09 |
| `path_evidence_files` | `table` | 4096 | 299008 | 247523 | 38285 | 0.09 |
| `idx_file_path_evidence_path` | `index` | unknown | 274432 | 247523 | 13781 | 0.08 |
| `idx_path_evidence_files_file` | `index` | unknown | 274432 | 247523 | 13781 | 0.08 |
| `idx_path_evidence_source` | `index` | unknown | 245760 | 229248 | 3508 | 0.07 |
| `idx_path_evidence_target` | `index` | unknown | 245760 | 229248 | 3508 | 0.07 |
| `source_content_template` | `table` | 2718 | 200704 | 173610 | 18356 | 0.06 |
| `sqlite_autoindex_source_content_template_1` | `index` | unknown | 196608 | 157480 | 30402 | 0.06 |
| `sqlite_stat4` | `table` | 1136 | 155648 | 139293 | 9695 | 0.05 |
| `sqlite_autoindex_path_evidence_1` | `index` | unknown | 143360 | 114560 | 16096 | 0.04 |
| `sqlite_autoindex_path_evidence_lookup_1` | `index` | unknown | 143360 | 114560 | 16096 | 0.04 |
| `sqlite_autoindex_edge_provenance_dict_1` | `index` | unknown | 131072 | 109352 | 17728 | 0.04 |
| `callsites` | `table` | 2177 | 126976 | 99947 | 20130 | 0.04 |
| `idx_path_evidence_edges_path_ordinal` | `index` | unknown | 126976 | 106496 | 7824 | 0.04 |
| `edge_provenance_dict` | `table` | 1204 | 118784 | 107072 | 5369 | 0.04 |
| `idx_path_evidence_lookup_signature` | `index` | unknown | 106496 | 88911 | 4989 | 0.03 |
| `idx_files_content_template` | `index` | unknown | 102400 | 79344 | 7835 | 0.03 |
| `sqlite_autoindex_files_1` | `index` | unknown | 61440 | 34569 | 11770 | 0.02 |
| `stage0_fts_content` | `table` | 186 | 61440 | 52348 | 7753 | 0.02 |
| `stage0_fts_data` | `table` | 17 | 45056 | 28725 | 15973 | 0.01 |
| `sqlite_schema` | `schema` | unknown | 32768 | 25688 | 6293 | 0.01 |
...
| `sqlite_stat4` | 1136 | 155648 | 139293 | 137.01 | 122.62 |
...
| `sqlite_stat1` | 63 | 4096 | 3097 | 65.02 | 49.16 |
