...
- Status: **failed**
- DB: `<REPO_ROOT>/Desktop\development\codegraph-mcp\reports\final\artifacts\comprehensive_proof_1778642765060.sqlite`
- Iterations: `20`

| Query | Status | p50 ms | p95 ms | p99 ms | rows | target p95 |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 1.947 | 3.291 | 3.291 | 20 | 250.000 |
| `symbol_lookup` | `fail` | 230.956 | 293.493 | 293.493 | 20 | 250.000 |
| `qname_lookup` | `pass` | 30.991 | 32.488 | 32.488 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.093 | 0.307 | 0.307 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 264.638 | 277.511 | 277.511 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 247.827 | 276.809 | 276.809 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 2.723 | 3.711 | 3.711 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 52.124 | 70.205 | 70.205 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 138.397 | 159.070 | 159.070 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 96.276 | 119.673 | 119.673 | 0 | 1000 |
