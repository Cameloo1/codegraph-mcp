...
Cases: 11 total, 11 passed, 0 failed. Top-k: 10. Token budget: 4000.

## Aggregate Metrics

| Metric | Value |
| --- | ---: |
| Context symbol recall@10 | 1.000 |
...
| Useful facts per estimated token | 0.002 |
...
| `barrel_export_default_export_resolution` | `passed` | 1.000 | 0 | 0.000 | 2/2 | 22 | 1.000 | 2/2 | 0/0 | 0.001 |
| `derived_closure_edge_requires_provenance` | `passed` | 1.000 | 0 | 0.000 | 1/1 | 20 | 1.000 | 2/2 | 0/0 | 0.000 |
| `dynamic_import_marked_heuristic` | `passed` | 1.000 | 0 | 0.000 | 0/0 | 12 | unknown | 1/1 | 0/0 | 0.000 |
...
| `same_function_name_only_one_imported` | `passed` | 1.000 | 0 | 0.000 | 1/1 | 27 | 1.000 | 1/1 | 0/0 | 0.000 |
| `sanitizer_exists_but_not_on_flow` | `passed` | 1.000 | 0 | 0.000 | 0/0 | 27 | unknown | 1/1 | 0/0 | 0.000 |
| `source_span_exact_callsite` | `passed` | 1.000 | 0 | 0.000 | 1/1 | 14 | 1.000 | 1/1 | 0/0 | 0.000 |
| `stale_graph_cache_after_edit_delete` | `passed` | 1.000 | 0 | 0.000 | 1/1 | 8 | 1.000 | 1/1 | 0/0 | 0.001 |
| `test_mock_not_production_call` | `passed` | 1.000 | 0 | 0.000 | 1/1 | 37 | 1.000 | 3/3 | 1/1 | 0.000 |
