...
- Status: **passed**
- DB: `<REPO_ROOT>/Desktop\development\codegraph-mcp\reports\audit\artifacts\minimal_storage_package_autoresearch_proof.sqlite`
- Iterations: `20`

| Query | Status | p50 ms | p95 ms | p99 ms | rows | target p95 |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `entity_name_lookup` | `pass` | 2.467 | 3.609 | 3.609 | 20 | 250.000 |
| `symbol_lookup` | `pass` | 191.002 | 222.471 | 222.471 | 20 | 250.000 |
| `qname_lookup` | `pass` | 18.846 | 20.610 | 20.610 | 1 | 250.000 |
| `text_fts_query` | `pass` | 0.102 | 0.263 | 0.263 | 4 | 500.000 |
| `relation_query_calls` | `pass` | 235.755 | 262.756 | 262.756 | 50 | 500.000 |
| `relation_query_reads_writes` | `pass` | 239.631 | 277.153 | 277.153 | 50 | 500.000 |
| `path_evidence_lookup` | `pass` | 2.539 | 4.301 | 4.301 | 50 | 500.000 |
| `source_snippet_batch_load` | `pass` | 51.859 | 62.622 | 62.622 | 50 | 500.000 |
| `context_pack_normal` | `pass` | 130.557 | 146.428 | 146.428 | 1 | 2000 |
| `unresolved_calls_paginated` | `pass` | 90.630 | 102.453 | 102.453 | 0 | 1000 |
