...
- Verdict: **fail**
- Reason: failed targets: bytes_per_proof_edge, cold_proof_build_total_wall_ms, proof_db_mib, proof_db_mib_stretch, single_file_update_total_ms, update_global_work_accidentally_triggered
...
| Metric | Target | Observed | Status | Notes |
| --- | --- | --- | --- | --- |
| `single_file_update_total_ms` | 750.000 | 1694 | fail | Single-file update p95 target is <=750 ms. |
| `update_file_walk_time_ms` | reported | 0.000 | pass | File walk span. |
| `update_read_time_ms` | reported | 0.048 | pass | File read span. |
| `update_hash_time_ms` | reported | 0.006 | pass | File hash span. |
| `update_parse_time_ms` | reported | 0.519 | pass | Parse span. |
| `update_stale_delete_time_ms` | reported | 279.723 | pass | Indexed stale fact cleanup span. |
...
| `update_proof_entity_update_time_ms` | reported | 131.196 | pass | Proof entity insertion/update span. |
| `update_proof_edge_update_time_ms` | reported | 154.843 | pass | Proof edge insertion/update span. |
| `update_dirty_path_evidence_count` | reported | 2 | pass | Dirty PathEvidence rows regenerated. |
| `update_path_evidence_regeneration_time_ms` | reported | 1.371 | pass | PathEvidence regeneration span. |
| `update_index_maintenance_time_ms` | reported | 0.000 | pass | Index maintenance span. |
| `update_transaction_commit_time_ms` | reported | unknown | unknown | Transaction commit time is not persisted separately. |
| `update_integrity_or_quick_check_time_ms` | reported | 4420 | pass | Validation integrity duration captured outside the fast path. |
| `update_graph_hash_update_time_ms` | reported | 462.750 | pass | Graph fact hash measurement; current harness still runs a global check. |
| `update_restore_time_ms` | reported | 1587 | pass | Restore update duration from update-integrity harness. |
...
| `update_global_work_accidentally_triggered` | false | true | fail | Fast path should avoid full graph hash scans unless validation mode explicitly requests them. |
