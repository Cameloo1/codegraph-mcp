...
pub use mvp3_validation_fixtures::{
    ...
    run_mvp3_9_cross_phase_regression_gate, run_mvp3_9_graph_delta_gate,
    run_mvp3_9_hallucination_interrupt_gate, run_mvp3_9_hot_path_reindex_gate,
    run_mvp3_9_release_final_gate_orchestrator, run_mvp3_9_route_bridge_inert_contract_gate,
    run_mvp3_9_sample_gate, run_mvp3_gate, run_mvp3_validation_fixture_by_id,
    run_mvp3_validation_fixture_family, run_mvp3_validation_fixtures,
    validate_mvp3_gate_result_value, validate_mvp3_validation_fixture_manifest_value,
    write_mvp3_gate_result_artifacts, Mvp3FixtureAssertionReport, Mvp3FixtureCommandRecord,
    Mvp3FixtureResult, Mvp3FixtureSurfaceRun, Mvp3GateFailure, Mvp3GateInvariantCounters,
    Mvp3GateResult, Mvp3GateResultArtifacts, Mvp3GateRunnerOptions, Mvp3SurfaceSupport,
    Mvp3ValidationFixtureManifest, Mvp3ValidationFixtureRunReport, Mvp3ValidationFixtureRunnerMode,
    Mvp3ValidationFixtureRunnerOptions, MVP3_9_CROSS_PHASE_REGRESSION_FIXTURE_IDS,
